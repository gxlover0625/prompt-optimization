...
- [textgrad](https://github.com/zou-group/textgrad) ![Star](https://img.shields.io/github/stars/zou-group/textgrad.svg?style=social&label=Star), Automatic ''Differentiation'' via Text -- using large language models to backpropagate textual gradients.
- [PromptBreeder](https://github.com/vaughanlove/PromptBreeder) ![Star](https://img.shields.io/github/stars/vaughanlove/PromptBreeder.svg?style=social&label=Star), Google Deepmind's PromptBreeder for automated prompt engineering implemented in langchain expression language.
- [MetaGPT](https://github.com/FoundationAgents/MetaGPT) ![Star](https://img.shields.io/github/stars/FoundationAgents/MetaGPT.svg?style=social&label=Star), The Multi-Agent Framework: First AI Software Company, Towards Natural Language Programming
- [DSPy](https://github.com/stanfordnlp/dspy) ![Star](https://img.shields.io/github/stars/stanfordnlp/dspy.svg?style=social&label=Star), The framework for programming—not prompting—language models.