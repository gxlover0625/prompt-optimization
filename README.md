...
- [textgrad](https://github.com/zou-group/textgrad) ![Star](https://img.shields.io/github/stars/zou-group/textgrad.svg?style=social&label=Star), a tool for text gradient estimation.
- [PromptBreeder](https://github.com/vaughanlove/PromptBreeder) ![Star](https://img.shields.io/github/stars/vaughanlove/PromptBreeder.svg?style=social&label=Star), a tool for prompt optimization.